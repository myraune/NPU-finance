    ...
    <>
      ...
      <section className="relative min-h-[60svh] md:min-h-[70svh] w-full overflow-hidden flex items-end">
        ...
        <div className="relative z-10 px-6 md:px-12 lg:px-16 pt-24 pb-14 md:py-24 max-w-5xl w-full">
          ...
          <ul className="reveal reveal-d3 mt-6 md:mt-8 flex flex-col sm:flex-row sm:flex-wrap gap-y-2 sm:gap-x-6 md:gap-x-8 text-[13px] md:text-[16px] text-white/85 list-none">
              ...
              <div className="mt-12 md:mt-14 pt-8 md:pt-10 border-t border-border-subtle grid sm:grid-cols-2 gap-5 sm:gap-6 max-w-2xl">
                <div>
                  ...
                  <a
                    ...
                    className="text-accent hover:text-accent-light transition-colors text-sm md:text-[16px] font-medium break-all"
                  >
                    {CONTACT_EMAIL}
                  </a>
                </div>
                <div>
                  ...
                  <a
                    ...
                    className="inline-flex items-center gap-2 text-accent hover:text-accent-light transition-colors text-sm md:text-[16px] font-medium"
                  >

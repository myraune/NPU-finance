            ...
            <ScrollReveal>
              ...
              >
                <div>
                  <label
                    htmlFor="name"
                    className="block text-text-tertiary text-[11px] font-medium tracking-[0.1em] uppercase mb-2"
                  >
                    Name
                  </label>
                  <input
                    ...
                    className="w-full bg-surface-1 border border-white/[0.06] px-4 py-3 focus:border-accent focus:ring-1 focus:ring-accent/20 rounded-lg text-text-primary placeholder:text-text-muted outline-none transition-all duration-300 text-[15px]"
                  />
                </div>
                ...
                <div>
                  ...
                  <select
                    id="subject"
                    className="w-full bg-surface-1 border border-white/[0.06] px-4 py-3 focus:border-accent focus:ring-1 focus:ring-accent/20 rounded-lg text-text-primary outline-none transition-all duration-300 text-[15px]"
                  >
                ...
                <div>
                  ...
                  <textarea
                    ...
                    className="w-full bg-surface-1 border border-white/[0.06] px-4 py-3 focus:border-accent focus:ring-1 focus:ring-accent/20 rounded-lg text-text-primary placeholder:text-text-muted outline-none transition-all duration-300 text-[15px] resize-none"
                  />
                </div>

                <button
                  type="submit"
                  className="mt-4 rounded-lg bg-accent text-base font-semibold glow-accent-hover px-8 py-4 transition-all duration-300 hover:bg-accent-light w-full md:w-auto text-sm"
                >
                  Send Message
                </button>
              </form>
          ...
          <ScrollReveal direction="left">
            <div className="space-y-10">
              <div className="border-l-2 border-accent/20 pl-4">
                ...
                <a
                  href="mailto:npfis@northpark.edu"
                  className="text-text-primary text-lg hover:text-accent transition-colors duration-300"
                >
                  npfis@northpark.edu
                </a>
              </div>
              ...
              <div className="border-l-2 border-accent/20 pl-4">
                ...
                <div className="flex gap-3 mt-3">
                  ...
                  <a
                    href="#"
                    className="rounded-lg bg-surface-2 p-2.5 hover:bg-accent/10 hover:text-accent transition-all duration-300 text-text-secondary"

...
const InteractiveMap = dynamic(() => import("@/components/InteractiveMap"), {
  ssr: false,
  loading: () => (
    <div className="w-full h-[400px] rounded-2xl bg-surface-1 border border-border-subtle flex items-center justify-center">
...
export default function Contact() {
  ...
  const inputClass =
    "w-full bg-surface-1 border border-border-subtle px-4 py-3 focus:border-accent focus:ring-1 focus:ring-accent/20 rounded-lg text-text-primary placeholder:text-text-muted outline-none transition-all duration-300 text-[15px]";
  ...
  return (
    <>
            ...
            <ScrollReveal>
              <form onSubmit={handleSubmit} className="space-y-6 max-w-lg">
                ...
                <button
                  ...
                  className="group relative overflow-hidden mt-4 rounded-lg bg-accent text-base font-semibold glow-accent-hover px-8 py-4 transition-all duration-300 hover:bg-accent-light hover:scale-[1.02] w-full md:w-auto text-sm disabled:opacity-50 disabled:hover:scale-100 btn-shimmer"
                >
            ...
            <div className="space-y-10">
              ...
              <div className="border-l-2 border-accent/20 pl-4">
                ...
                <div className="flex gap-3 mt-3">
                  <a href="https://www.linkedin.com/company/north-park-university-finance-and-investment-society" target="_blank" rel="noopener noreferrer" className="rounded-lg bg-surface-2 p-2.5 hover:bg-accent/10 hover:text-accent transition-all duration-300 text-text-secondary" aria-label="LinkedIn">
                    <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24"><path d="M20.447 20.452h-3.554v-5.569c0-1.328-.027-3.037-1.852-3.037-1.853 0-2.136 1.445-2.136 2.939v5.667H9.351V9h3.414v1.561h.046c.477-.9 1.637-1.85 3.37-1.85 3.601 0 4.267 2.37 4.267 5.455v6.286zM5.337 7.433a2.062 2.062 0 01-2.063-2.065 2.064 2.064 0 112.063 2.065zm1.782 13.019H3.555V9h3.564v11.452zM22.225 0H1.771C.792 0 0 .774 0 1.729v20.542C0 23.227.792 24 1.771 24h20.451C23.2 24 24 23.227 24 22.271V1.729C24 .774 23.2 0 22.222 0h.003z" /></svg>
                  </a>
                  <a href="https://www.instagram.com/fis_npu/" target="_blank" rel="noopener noreferrer" className="rounded-lg bg-surface-2 p-2.5 hover:bg-accent/10 hover:text-accent transition-all duration-300 text-text-secondary" aria-label="Instagram">
      ...
      {/* ---- MAP ---- */}
      <section className="bg-base px-6 md:px-12 lg:px-16 py-16">
        <ScrollReveal>
          <p className="text-[11px] tracking-[0.15em] uppercase font-medium text-accent mb-4">
            Find Us
          </p>

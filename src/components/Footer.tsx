        ...
        <div className="grid md:grid-cols-3 gap-12 md:gap-8">
          ...
          <div>
            ...
            <div className="flex gap-3 mt-5">
              {/* Instagram */}
              <a href="#" className="rounded-lg bg-surface-1 hover:bg-surface-2 p-2.5 text-text-secondary hover:text-accent transition-all duration-300" aria-label="Instagram">
              ...
              {/* LinkedIn */}
              <a href="#" className="rounded-lg bg-surface-1 hover:bg-surface-2 p-2.5 text-text-secondary hover:text-accent transition-all duration-300" aria-label="LinkedIn">
                <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 24 24">

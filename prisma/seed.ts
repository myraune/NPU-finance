  ...
  const events = await Promise.all([
    prisma.event.create({
      data: {
        ...
        description:
          "Learn the fundamentals of building a diversified portfolio. Open to all majors.",
        date: "2026-03-15",
        time: "5-7 PM",
    ...
    prisma.event.create({
      data: {
        ...
        description:
          "North Park alumni at top financial institutions share career journeys and advice.",
        date: "2026-03-28",
        time: "6-8 PM",
    ...
    prisma.event.create({
      data: {
        ...
        description:
          "Present your best stock pick to a panel of judges. Cash prizes for top three.",
        date: "2026-04-10",
        time: "4-7 PM",
    ...
    prisma.event.create({
      data: {
        ...
        description:
          "Week-long series on personal finance, budgeting, and investing basics.",
        date: "2026-04-21",
        time: "Various",
